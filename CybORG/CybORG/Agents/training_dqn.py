...
def train_DQN(red_agent=B_lineAgent, num_eps=1, len_eps=1, replace=1000, mem_size=5000,
    ...
    for i in range(num_eps):
        ...
        print('episode: ', i, 'score: ', score,
              ...
              'action: ', env.get_last_action('Blue'))
...
def test_DQN(eps_len=100, num_eps=10, chkpt_dir="model_b_line", red_agent=B_lineAgent):
    CYBORG = CybORG(PATH, 'sim', agents={
        'Red': red_agent
    })
    env = ChallengeWrapper(env=CYBORG, agent_name="Blue")
    ...
    agent = DQNAgent(chkpt_dir=model_dir, algo='DQNAgent',
                     env_name='Scenario1b')
...
if __name__ == '__main__':
    ...
    #train_DQN(red_agent=B_lineAgent, num_eps=2000, len_eps=100, replace=5000, mem_size=5000, lr=0.0001, eps_dec=0.000005, eps_min=0.05, gamma=0.99, batch_size=32, epsilon=1, chkpt_dir="model_bline")
    test_DQN(chkpt_dir="model_b_line", red_agent=B_lineAgent)